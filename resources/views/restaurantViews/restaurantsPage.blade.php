				...
				@endif
                 <div class="col-md-4 col-sm-6 portfolio-item">
                    <a style = "@if($r->restaurant_status == 0) pointer-events: none; cursor: default; @else @endif ;"" center"  href="menu/{{$r->restaurant_name}}" class="portfolio-link disable" data-toggle="modal" >
                        ...
                        <img src="https://wailodile-storage.sfo2.digitaloceanspaces.com/wailodile-storage/restaurants/{{$r->header_image}}" class="img-responsive img-rounded" style="width: 1000px; height:auto; " alt="">
                    </a>
